...
before packages are loaded."
  ...
  ;;   (setq-default org-roam-directory "~/nixos/notes"))
  ...
  (bind-keys* :map evil-emacs-state-map
              ...
              ;; Navigating files
              ("C-o"   . spacemacs/find-file-and-replace-buffer)
