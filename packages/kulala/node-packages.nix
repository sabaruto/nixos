...
let
  sources = {
    "@mistweaverco/tree-sitter-graphql-1.9.0" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/@mistweaverco/tree-sitter-graphql/-/tree-sitter-graphql-1.9.0.tgz";
        sha512 =
          "XauMg8wywQaP5/54eBy+pJO8MvUgInkHwSftSNosqyCeSsf0nQuPfdiKs4bb7EBO0kv6UPcN87WfZdf+NZ5pgg==";
      };
    };
    "@mistweaverco/tree-sitter-kulala-1.9.0" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/@mistweaverco/tree-sitter-kulala/-/tree-sitter-kulala-1.9.0.tgz";
        sha512 =
          "4F+kCZFEvurSGrWM52lnowXBOqQ5+nfzxp55ufCqTdDSzSI92kySHmlhF7d2g/ZW4Jjrbromh1WH9XK/mHPbzQ==";
      };
    };
    "node-addon-api-8.1.0" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/node-addon-api/-/node-addon-api-8.1.0.tgz";
        sha512 =
          "yBY+qqWSv3dWKGODD6OGE6GnTX7Q2r+4+DfpqxHSHh8x0B4EKP9+wVGLS6U/AM1vxSNNmUEuIV5EGhYwPpfOwQ==";
      };
    };
    ...
    "tree-sitter-0.21.1" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "7dxoA6kYvtgWw80265MyqJlkRl4yawIjO7S5MigytjELkX43fV2WsAXzsNfO7sBpPPCF5Gp0+XzHk0DwLCq3xQ==";
      };
    };
  };
in nodeEnv.buildNodePackage {
  ...
  src = fetchurl {
    url =
      "https://registry.npmjs.org/@mistweaverco/kulala-ls/-/kulala-ls-1.9.0.tgz";
    sha512 =
      "X9gMkAagMAmPOWph4HS0OF998tzmGNdScfOyoWcySFolmhlVo084UIltRIeMwGt5dTVeCraEj9GabdZChZOhxg==";
  };
  dependencies = [
